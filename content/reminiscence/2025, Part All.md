...
- https://www.blind-alley.com/ - one of those comics that's going *somewhere*, even if i have no idea where?
There's more we read that year, but didn't really log? I *think* Stand Still, Stay Silent was one we read in 2025...but entirely unsure. Good story, even though the author would currently disavow its setting, which is a real tragedy.
...
- [so there's this really small game jam thing i made for a really small game jam](https://rinions.itch.io/shrines) that is like, idk, i feel like saying too much about it is counterproductive? i didn't get enough done, and there's a lot of rough edges, but it was a good experience! first game jam in a couple years.
